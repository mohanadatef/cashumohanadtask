                            ...
                            <form action="{{route('role.store')}}" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ Request::old('name') }}" placeholder="Enter name">
                                    </div>
                                <div class="row">
                                        <div class="form-group{{ $errors->has('permission_id') ? ' has-error' : "" }}">
                                            ...
                                            <select class="duallistbox" multiple="multiple" name="permission[]">
                                                ...
                                                <option  value="{{$pe->id}}">{{$pe->show_name}}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                        <!-- /.form-group -->
